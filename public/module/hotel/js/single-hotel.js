                ...
                if (me.start_date !== "" && me.total_rooms > 0) {
                    ...
                    for (var ix in me.extra_price) {
                        ...
                        if (item.enable === true) {
                            switch (item.type) {
                                case "one_time":
                                    type_total += parseFloat(item.price) * me.total_rooms;
                                    break;
                                case "per_day":
                                    type_total += parseFloat(item.price) * Math.max(1,duration_in_day) * me.total_rooms;
                                    break;
                            }
            ...
            pay_now_price:function(){
                if(this.is_deposit_ready){
                    switch (this.deposit_type) {
                        case "percent":
                            return this.total_price * this.deposit_amount / 100;
                            break;
                        default:
